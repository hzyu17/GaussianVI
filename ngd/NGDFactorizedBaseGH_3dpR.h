...
class NGDFactorizedBaseGH_3dpR: public GVIFactorizedBaseGH_Cuda{
...
public:
    ...
    NGDFactorizedBaseGH_3dpR(int dimension, int state_dim, int gh_degree, 
                ...
                _radius(radius)
            {
                ...
                // _cuda = std::make_shared<CudaOperation_3dpR>(CudaOperation_3dpR{cost_sigma, epsilon, radius});
                _cuda = cuda_ptr;
...
public:
    ...
    std::shared_ptr<CudaOperation_3dpR> _cuda;
