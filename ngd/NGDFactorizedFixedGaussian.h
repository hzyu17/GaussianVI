...
using NGDFactorizedFixedGaussian = NGDFactorizedLinear<FixedPriorGP>;

// class NGDFactorizedFixedGaussian : public NGDFactorizedLinear<LinearFactor>{
//     using Base = NGDFactorizedLinear<LinearFactor>;
//     using LinearCostFunction = std::function<double(const VectorXd&, const LinearFactor&)>;
// public:
//     NGDFactorizedFixedGaussian(const int& dimension,
//                                 int dim_state,
//                                 // int gh_degree,
//                                 const LinearCostFunction& function, 
