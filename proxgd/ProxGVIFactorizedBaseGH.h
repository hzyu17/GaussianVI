...
public:
    ...
    void calculate_partial_V() override{
        ...
        Eigen::VectorXd bk(this->_dim);
        Eigen::MatrixXd Sk(this->_dim, this->_dim);

        bk.setZero();
        Sk.setZero();

        bk = this->_precision * this->_gh->Integrate(this->_func_Vmu);
        Sk = this->_precision * this->_gh->Integrate(this->_func_Vmumu) * this->_precision - this->_precision*this->_gh->Integrate(this->_func_phi);
        ...
        Eigen::VectorXd mk_new = this->_mu - this->_step_size * bk;
