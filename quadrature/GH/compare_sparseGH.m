...
disp('------------ Difference in the integration Int1 ------------')
norm(Int1 - SGappr1, 'fro')
...
disp('------------ Difference in the integration Int2 ------------')
norm(Int2 - SGappr2, 'fro')
...
disp('------------ Difference in the integration Int3 ------------')
norm(Int3 - SGappr3, 'fro')
...
disp('------------ Relative Difference in the integration Int21 ------------')
norm((Int21 - SGappr21) / Int21, 'fro')
...
disp('Time elapsed full grid GH')
toc
